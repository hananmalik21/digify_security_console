...
import 'package:digify_security_console/security_console/presentation/widgets/roles_management/roles_selection_tile.dart';
...
class InheritedJobRolesSection extends StatelessWidget {
  const InheritedJobRolesSection({
    super.key,
    ...
    return Column(
      ...
      children: [
        Wrap(
          ...
          runSpacing: 4.h,
          children: [
            Text('Inherited Job Roles', style: context.textTheme.titleMedium?.copyWith(color: AppColors.textPrimary)),
            Text(
        ...
        Gap(8.h),
        Text(
          'Optional. Duty, function, and data role assignments from selected job roles can be merged into this role.',
          style: context.textTheme.bodySmall?.copyWith(color: AppColors.textSecondary, height: 1.35),
        ),
        Gap(12.h),
        DigifyTextField.search(
          controller: searchController,
          hintText: 'Search by name, code or job title...',
          filled: true,
            ...
            children: [
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: isLoading
                      ? const _InheritedJobRoleListSkeleton()
                      : roles.isEmpty
                      ? Center(
                          child: Text(
                            'No job roles found.',
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return RolesSelectionTile(
                              title: role.name,
                              code: role.code,
                              moduleName: role.jobTitle,
                              leadingIconPath: JobRoleFormConfig.basicInfoIconPath,
                              isActive: role.isActive,
                              isSelected: selectedGuids.contains(role.jobRoleGuid),
                              onTap: () => onRoleToggle(role.jobRoleGuid),
                            );
                          },
                        ),
                ),
...
class _InheritedJobRoleListSkeleton extends StatelessWidget {
  const _InheritedJobRoleListSkeleton();
