...
class RoleDelegationStatsCards extends StatelessWidget {
  final bool isDark;
  final List<RoleDelegationStat> stats;

  const RoleDelegationStatsCards({super.key, required this.isDark, required this.stats});
...
class RoleDelegationStat {
  final String title;
  final String value;
  final String iconPath;
  final Color iconColor;

  const RoleDelegationStat({
    required this.title,
    required this.value,
...
class _RoleDelegationStatCard extends StatelessWidget {
  final String title;
  final String value;
  final String iconPath;
  final Color iconColor;
