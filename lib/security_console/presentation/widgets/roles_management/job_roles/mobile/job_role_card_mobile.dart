...
class JobRoleCardMobile extends StatelessWidget with RolesManagementPermissionMixin {
  const JobRoleCardMobile({
    super.key,
    required this.role,
...
class _RolePreviewSection extends StatelessWidget {
  const _RolePreviewSection({required this.title, required this.iconPath, required this.items, required this.isDark});
