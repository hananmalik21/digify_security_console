...
import 'package:digify_core/widgets/common/distribution_list_card.dart';
...
class SecurityDistributionSection extends StatelessWidget {
  ...
  Widget _buildUserDistribution(SecurityConsoleLocalizations l10n) {
  ...
  Widget _buildRoleDistribution(SecurityConsoleLocalizations l10n) {
    return DistributionListCard(
