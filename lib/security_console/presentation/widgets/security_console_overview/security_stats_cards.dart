...
class SecurityStatsCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cards = [
      ...
      _SecurityStatCard(
        label: localizations.totalRoles,
        value: '0',
        iconPath: Assets.icons.positionsIcon.path,
        isDark: isDark,
      ),
      _SecurityStatCard(
        label: localizations.mfaProtected,
        value: '0',
...
class _SecurityStatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconBgColor = isDark
        ...
        : SecurityStatsCards._iconBackgroundLight;
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: DigifyAsset(
              assetPath: iconPath,
              color: SecurityStatsCards._iconColor,
              width: 21,
              height: 21,
            ),
          ),
