...
class DutyRoleFunctionRolesSelectionState {
  const DutyRoleFunctionRolesSelectionState({
    this.roles = const [],
  ...
  DutyRoleFunctionRolesSelectionState copyWith({
    ...
    return DutyRoleFunctionRolesSelectionState(
...
class DutyRoleFunctionRolesSelectionNotifier extends StateNotifier<DutyRoleFunctionRolesSelectionState> {
  DutyRoleFunctionRolesSelectionNotifier(this._useCase, this._ref) : super(const DutyRoleFunctionRolesSelectionState());
...
final dutyRoleFunctionRolesSelectionProvider =
