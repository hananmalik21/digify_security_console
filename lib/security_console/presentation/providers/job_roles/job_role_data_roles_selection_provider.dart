...
class JobRoleDataRolesSelectionState {
  const JobRoleDataRolesSelectionState({
    this.roles = const [],
  ...
  List<DataRoleItem> get paginatedRoles => roles;

  List<DataRoleItem> get filteredRoles => roles;

  JobRoleDataRolesSelectionState copyWith({
    ...
    return JobRoleDataRolesSelectionState(
...
class JobRoleDataRolesSelectionNotifier extends StateNotifier<JobRoleDataRolesSelectionState> {
  JobRoleDataRolesSelectionNotifier(this._useCase, this._ref) : super(const JobRoleDataRolesSelectionState());
  ...
  Future<void> _fetchPage(int page, {bool resetSearch = false}) async {
    ...
    try {
      ...
      final items = result.roles.map(DataRoleItem.fromDataRole).toList();
