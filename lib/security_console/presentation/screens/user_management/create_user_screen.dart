...
class CreateUserScreen extends ConsumerStatefulWidget {
  static const String routeName = 'security-manager-user-add';
        ...
        child: Column(
          children: [
            DigifyTabHeader(
              ...
              description:
                  'Add a new user to the system by providing account details, roles, and security permissions.',
              trailing: Row(
                children: [
                  ...
                  Gap(12.w),
                  AppButton.primary(
                    label: isLastStep ? 'Save User' : 'Continue',
            ...
            Gap(24.h),
            _CreateUserStepper(currentStep: state.step, maxStepIndex: state.maxStepIndex),
            Gap(24.h),
...
class _CreateUserStepper extends StatelessWidget {
  final CreateUserStep currentStep;
  final int maxStepIndex;

  const _CreateUserStepper({required this.currentStep, required this.maxStepIndex});
