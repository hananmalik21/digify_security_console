...
final gradeStructureSelectedEnterpriseProvider = StateNotifierProvider<WorkforceEnterpriseNotifier, int?>((ref) {
...
final gradeStructureEnterpriseIdProvider = Provider<int?>((ref) {
  final selected = ref.watch(gradeStructureSelectedEnterpriseProvider);
