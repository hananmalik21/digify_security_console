...
final reportingStructureSelectedEnterpriseProvider = StateNotifierProvider<WorkforceEnterpriseNotifier, int?>((ref) {
...
final reportingStructureEnterpriseIdProvider = Provider<int?>((ref) {
  final selected = ref.watch(reportingStructureSelectedEnterpriseProvider);
