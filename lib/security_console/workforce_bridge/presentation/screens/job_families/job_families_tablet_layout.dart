...
class JobFamiliesTabletLayout extends StatelessWidget with JobFamiliesPermissionMixin {
  const JobFamiliesTabletLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
