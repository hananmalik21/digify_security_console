...
class JobLevelsDesktopLayout extends StatelessWidget with JobLevelsPermissionMixin {
  const JobLevelsDesktopLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
