...
class PositionsDesktopLayout extends StatelessWidget with PositionsPermissionMixin {
  const PositionsDesktopLayout({required this.selectedEnterpriseId, required this.onEnterpriseChanged, super.key});
