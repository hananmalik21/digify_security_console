...
import 'package:digify_security_console/security_console/workforce_bridge/presentation/widgets/positions/form/position_form_sections.dart';
...
class PositionFormDialog extends ConsumerStatefulWidget {
  ...
  static Future<void> show(BuildContext context, {required Position position, required bool isEdit}) {
    final title = isEdit ? SecurityConsoleLocalizations.of(context)!.editPosition : 'Add New Position';
