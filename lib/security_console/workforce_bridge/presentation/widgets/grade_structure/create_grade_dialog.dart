...
import 'package:digify_security_console/security_console/workforce_bridge/presentation/providers/create_grade_form_state_provider.dart';
...
import 'package:digify_security_console/security_console/workforce_bridge/presentation/widgets/grade_structure/create_ent_lookup_value_dialog.dart';
...
class _CreateGradeDialogState extends ConsumerState<CreateGradeDialog> {
  ...
  Widget _buildGradeFields(SecurityConsoleLocalizations localizations, bool isMobileForm) {
    if (isMobileForm) {
      return Column(
  ...
  Widget _buildGradeNumberField(SecurityConsoleLocalizations localizations) {
  ...
  Widget _buildGradeCategoryField(SecurityConsoleLocalizations localizations) {
  ...
  Widget _buildStepSalaries(SecurityConsoleLocalizations localizations, bool isMobileForm) {
  ...
  Widget _buildStepInput(
    SecurityConsoleLocalizations localizations,
    String label,
  ...
  Widget _buildDescription(SecurityConsoleLocalizations localizations) {
    final formNotifier = ref.read(createGradeFormStateProvider.notifier);
