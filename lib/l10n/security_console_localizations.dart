...
import 'security_console_localizations_ar.dart';
import 'security_console_localizations_en.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of SecurityConsoleLocalizations
/// returned by `SecurityConsoleLocalizations.of(context)`.
///
/// Applications need to include `SecurityConsoleLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'l10n/security_console_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: SecurityConsoleLocalizations.localizationsDelegates,
///   supportedLocales: SecurityConsoleLocalizations.supportedLocales,
...
/// be consistent with the languages listed in the SecurityConsoleLocalizations.supportedLocales
/// property.
abstract class SecurityConsoleLocalizations {
  SecurityConsoleLocalizations(String locale)
    : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static SecurityConsoleLocalizations of(BuildContext context) {
    return Localizations.of<SecurityConsoleLocalizations>(
      context,
      SecurityConsoleLocalizations,
    )!;
  }

  static const LocalizationsDelegate<SecurityConsoleLocalizations> delegate =
      _SecurityConsoleLocalizationsDelegate();
...
class _SecurityConsoleLocalizationsDelegate
    extends LocalizationsDelegate<SecurityConsoleLocalizations> {
  const _SecurityConsoleLocalizationsDelegate();

  @override
  Future<SecurityConsoleLocalizations> load(Locale locale) {
    return SynchronousFuture<SecurityConsoleLocalizations>(
      lookupSecurityConsoleLocalizations(locale),
    );
  }
  ...
  @override
  bool shouldReload(_SecurityConsoleLocalizationsDelegate old) => false;
}

SecurityConsoleLocalizations lookupSecurityConsoleLocalizations(Locale locale) {
  // Lookup logic when only language code is specified.
  switch (locale.languageCode) {
    case 'ar':
      return SecurityConsoleLocalizationsAr();
    case 'en':
      return SecurityConsoleLocalizationsEn();
  }

  throw FlutterError(
    'SecurityConsoleLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
